...
import com.hyp.crm.workbench.dao.*;
import com.hyp.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //(2)通过线索对象提取客户信息，当客户不存在的时候，新建客户（根据公司的名称精确匹配，判断该客户是否存在客户表里）
        String company = c.getCompany();
        Customer cus = customerDao.getCustomerByName(company);
        //如果cus为null，说明以前没有这个客户，需要重新建一个
        if (cus == null) {
            cus = new Customer();
        ...
        //经过第三步处理后，联系人的信息我们已经拥有了，将来在处理其他表的时候，
        // 如果要使用到联系人的id直接使用con.getId();
        ...
        //遍历出每一亲与市场活动关联的关联关系记录
        for (ClueActivityRelation clueActivityRelation : clueActivityRelationList) {
            //从每—条遍历出来的记录中取出关联的市场活动id
