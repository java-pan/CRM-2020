...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                        ...
                        * */
                        if (data.success) {
                            ...
                            * 注意:
                            ...
                            对于表单的jquery对象，提供了submit(o方法让我们提交表单
            ...
            $("#searchBtn").click(function () {
                ...
                * */
                ...
                $("#hidden-enDate").val($.trim($("#search-endDate").val()));
                pageList(1,$("#activityPage").bs_pagination('getOption', 'rowsPerPage'));
            ...
            *
            //以下这种做法是不行的
        S("input[ name=xz ]" ).cLick(function () {
            alert(123);
                    })
        //因为动态生成的元素是不能够以昔通绑定事件的形式来进行操作的
            动态生成的元素，我们要以on方法的形式来触发事件
            语法:
                $(需要绑定元素的有效的外层元素) . on(绑定事件的方式,需要绑定的元素的jquery对象,回调函数)

            * 有效的元素的意思是：不是动态生成的元素就是有效的元素
            * */
        ...
        *		对于所有的关系型数据库，做前端的分页相关操作的基础组件就是pageNo和pageSize
                ...
                * (2)添加,修改,除后,需要刷新市场活动列表
                  (3)点击查询按钮的时候,需要刷新市场活动列表
                * (4）点击分页组件的时侯调用pageList方法
                *
                * 以上为pageList方法制定了六个入口，也就是说，
                * 在以上六个操作执行完毕后，我们必须要调用pageLst方法，刷新市场活动信息列表
                *
        ...
        * */
        function pageList(pageNo, pageSize) {
            ...
            $("#search-enDate").val($.trim($("#hidden-endDate").val()));
...
<input type="hidden" id="hidden-enDate"/>
<!-- 创建市场活动的模态窗口 -->
